    ...
    <el-row :gutter="20">
      <el-col :span="10" style="margin-left: 360px" class="main_container">
        ...
        <div class="video_detail">
          <iframe :src=videoProfileTemp scrolling="no" border="0" frameborder="no" framespacing="0" width="800px" height="500px" allowfullscreen="true" sandbox="allow-top-navigation allow-same-origin allow-forms allow-scripts"> </iframe>
        </div>
        <div class="video_info">
          视频简介：{{temp.videoProfile}}
        </div>
      </el-col>
...
<script>
  ...
  export default {
    ...
    methods: {
      fetchData(id) {
        WebApi.findOneVideo(id).then(data => {
          this.temp = data
      ...
      getRefresh() {
        WebApi.findAllVideo(this.listQuery).then(data => {
          ...
          this.videoProfileTemp = '//player.bilibili.com/player.html?aid=' + this.temp.videoUrl + '&cid=21890669&page=1&high_quality=1&danmaku=0'
        })
      }
    }
  }
